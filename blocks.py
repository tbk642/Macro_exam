...
@nb.njit
def market_clearing(par,ini,ss,G,TFP,pi,i,C_hh,u,q,B,U_ALL_hh,U_UI_hh_guess,U_UI_hh,r,
    ...
    if par.RA:
        ...
        qB[:] = q*B
        for t in range(par.T):
            errors_assets[:] = C[t]**(-par.sigma) - par.beta_RA*(1+r_plus)*C_plus[t]**(-par.sigma)
